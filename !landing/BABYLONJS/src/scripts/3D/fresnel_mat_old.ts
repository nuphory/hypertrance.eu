...
export function fresnel_material(): NodeMaterial {
    ...
    Gradient.target = 4;
    Gradient.colorSteps = [];
    Gradient.colorSteps.push(new GradientBlockColorStep(0, new Color3(0, 0, 0)));
    Gradient.colorSteps.push(new GradientBlockColorStep(0.32, new Color3(0.43529411764705883, 0.6392156862745098, 0.9137254901960784)));
    Gradient.colorSteps.push(new GradientBlockColorStep(1, new Color3(1, 1, 1)));
    Gradient.colorSteps.push(new GradientBlockColorStep(1, new Color3(0.43529411764705883, 0.6392156862745098, 0.9137254901960784)));
