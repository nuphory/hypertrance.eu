...
export function fresnel_material(): NodeMaterial {
    ...
    Gradient.target = 4;
    Gradient.colorSteps = [];
    Gradient.colorSteps.push(new GradientBlockColorStep(0, new Color3(0.9058823529411765, 0.9921568627450981, 1)));
    Gradient.colorSteps.push(new GradientBlockColorStep(0.49, new Color3(0.34901960784313724, 0.6470588235294118, 0.6784313725490196)));
