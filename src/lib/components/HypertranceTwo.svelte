...
<div
	class="transition-quick duration-default ease-out relative mt-[24rem] md:mt-[32rem] lg:mt-[40rem] overflow-clip {$$restProps.class ||
		''}"
>
	<section id="premiere" class="container !p-0 !mb-0" in:fade={{ duration: 400 }}>
		<iframe
			...
			frameborder="0"
			title="Hypertrance 2"
			data-src="https://www.youtube-nocookie.com/embed/3sCu-zjVa5c?&autoplay=1&mute=1&controls=1&showinfo=1&start=9"
		/>
	</section>
				...
				<li class="ml-8">
					<div class="flex gap-1">
						...
						<span class="tracklist__title flex-1">
							{#if Object.keys(track.links).length > 0}
								<a
