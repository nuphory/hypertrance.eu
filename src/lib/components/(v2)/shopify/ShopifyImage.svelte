<script lang="ts">
	...
	import type { Image } from '$lib/shopify/zod/simple-types';

	export let image: z.infer<typeof Image>;
...
{:else}
	...
	<svg
		class="bg-neutral fill-text-neutral"
