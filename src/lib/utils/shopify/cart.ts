...
import { CreateCartMutation, CartLinesAddMutation, CartLinesRemoveMutation, CartLinesUpdateMutation, GetCartQuery } from './graphql/cart';
...
export async function addCartLines(id: string, lines: [{merchandiseId: string, quantity: number}]) {
